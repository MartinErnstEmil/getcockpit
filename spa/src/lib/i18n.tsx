...
const en: Dict = {
  ...
  "overview.today.delivered": "{n} answers picked up",
  "overview.today.delivered_one": "1 answer picked up",
  ...
  "overview.rec.undelivered": "{n} answered replies have not been picked up for over 2 h.",
  "overview.rec.undelivered_one": "One answered reply has not been picked up for over 2 h.",
  "overview.rec.undeliveredCta": "Open decision log",
  "delivery.waiting": "Waiting for pickup · {age}",
  "delivery.aging": "— start a session or copy",
  "delivery.copy": "Copy",
  "delivery.copied": "Copied!",
  "delivery.delivered": "Confirmed · {age} · {via}",
  "delivery.unacked": "Delivered, unconfirmed · {age}",
  "delivery.unackedHint": "— the agent hasn’t confirmed acting on it yet",
  "delivery.dead": "Could not be delivered",
  "delivery.resend": "Resend",
  "delivery.resending": "Resending…",
  "delivery.via.briefing": "at session start",
  "delivery.via.prompt": "into a running session",
  "delivery.via.mcp": "picked up by the agent",
  "delivery.session": "Session {id}",
  "delivery.ways": "Delivered automatically three ways: at the next session's start, into a running session, or when the agent actively picks it up.",
  ...
  "settings.selftest.title": "Delivery self-test",
  "settings.selftest.desc": "Proves the chain hook → pickup → injection on this machine — isolated, without touching real data.",
  "settings.selftest.run": "Test delivery",
  "settings.selftest.running": "Testing…",
  "settings.selftest.ok": "Delivery chain works ({ms} ms).",
  "settings.selftest.fail": "Delivery chain broken: {reason}",
...
const de: Dict = {
  ...
  "overview.today.delivered": "{n} Antworten abgeholt",
  "overview.today.delivered_one": "1 Antwort abgeholt",
  ...
  "overview.rec.undelivered": "{n} beantwortete Antworten seit über 2 h nicht abgeholt.",
  "overview.rec.undelivered_one": "Eine beantwortete Antwort ist seit über 2 h nicht abgeholt.",
  "overview.rec.undeliveredCta": "Zum Entscheidungs-Log",
  "delivery.waiting": "Wartet auf Abholung · {age}",
  "delivery.aging": "— Session starten oder kopieren",
  "delivery.copy": "Kopieren",
  "delivery.copied": "Kopiert!",
  "delivery.delivered": "Bestätigt · {age} · {via}",
  "delivery.unacked": "Zugestellt, unbestätigt · {age}",
  "delivery.unackedHint": "— vom Agenten noch nicht bestätigt",
  "delivery.dead": "Konnte nicht zugestellt werden",
  "delivery.resend": "Erneut senden",
  "delivery.resending": "Sendet…",
  "delivery.via.briefing": "beim Session-Start",
  "delivery.via.prompt": "in laufende Session",
  "delivery.via.mcp": "vom Agenten abgeholt",
  "delivery.session": "Session {id}",
  "delivery.ways": "Zugestellt wird automatisch auf drei Wegen: beim Start der nächsten Session, in eine laufende Session, oder wenn der Agent aktiv abholt.",
  ...
  "settings.selftest.title": "Zustell-Selbsttest",
  "settings.selftest.desc": "Beweist die Kette Hook → Abholung → Injektion auf dieser Maschine — isoliert, ohne echte Daten anzufassen.",
  "settings.selftest.run": "Zustellung testen",
  "settings.selftest.running": "Testet…",
  "settings.selftest.ok": "Zustell-Kette funktioniert ({ms} ms).",
  "settings.selftest.fail": "Zustell-Kette gestört: {reason}",
...
const fr: Dict = {
  ...
  "overview.today.delivered": "{n} réponses récupérées",
  "overview.today.delivered_one": "1 réponse récupérée",
  ...
  "overview.rec.undelivered": "{n} réponses ne sont pas récupérées depuis plus de 2 h.",
  "overview.rec.undelivered_one": "Une réponse n’est pas récupérée depuis plus de 2 h.",
  "overview.rec.undeliveredCta": "Ouvrir le journal des décisions",
  "delivery.waiting": "En attente de récupération · {age}",
  "delivery.aging": "— démarrez une session ou copiez",
  "delivery.copy": "Copier",
  "delivery.copied": "Copié !",
  "delivery.delivered": "Confirmé · {age} · {via}",
  "delivery.unacked": "Remis, non confirmé · {age}",
  "delivery.unackedHint": "— l’agent n’a pas encore confirmé",
  "delivery.dead": "N’a pas pu être remis",
  "delivery.resend": "Renvoyer",
  "delivery.resending": "Envoi…",
  "delivery.via.briefing": "au démarrage de session",
  "delivery.via.prompt": "dans une session en cours",
  "delivery.via.mcp": "récupéré par l’agent",
  "delivery.session": "Session {id}",
  "delivery.ways": "Livré automatiquement de trois façons : au démarrage de la prochaine session, dans une session en cours, ou quand l’agent le récupère activement.",
  ...
  "settings.selftest.title": "Autotest de livraison",
  "settings.selftest.desc": "Prouve la chaîne hook → récupération → injection sur cette machine — isolé, sans toucher aux données réelles.",
  "settings.selftest.run": "Tester la livraison",
  "settings.selftest.running": "Test…",
  "settings.selftest.ok": "La chaîne de livraison fonctionne ({ms} ms).",
  "settings.selftest.fail": "Chaîne de livraison rompue : {reason}",
